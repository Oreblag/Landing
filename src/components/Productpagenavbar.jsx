  ...
  return (
    <div>
        ...
        <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-1 gap-64 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                <div>
                    <button type="button" className="relative flex rounded-sm text-gray-800 border py-2 px-8 bg-yellow-400 text-sm font-medium active:bg-yellow-300 focus:outline-none focus:ring-1 focus:ring-yellow-300 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">Contact Us</button>
                </div>
