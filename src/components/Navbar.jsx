                ...
                <div className="relative flex h-16 justify-between items-center">
                    ...
                    <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                        ...
                        <div className="hidden sm:ml-6 sm:block">
                            <div className="flex justify-between space-x-48 w-100">
                                {/* <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-gray-700 hover:text-white" --> */}
                                <div className="flex space-x-12">
                                    <Link to='/' className="text-gray-500 hover:bg-gray-700 hover:text-white rounded-md px-3 py-4 text-sm font-small" aria-current="page">Home</Link>
                                    <Link to='/about' className="text-gray-500 hover:bg-gray-700 hover:text-white rounded-md px-3 py-4 text-sm font-small">About</Link>
                                    <Link to='/' className="text-gray-500 hover:bg-gray-700 hover:text-white rounded-md px-3 py-4 text-sm font-small">Contact</Link>
                                </div>
                                <div className="flex mx-auto text-center">
                                    <Link to='/' className="text-gray-800  px-3 py-2 font-bold text-3xl text-center ml-11">Landing</Link>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                        ...
                        <div className="relative ml-3">
                            <div>
                                <button type="button" className="relative flex rounded-sm text-white border py-2 px-16 bg-gray-800 text-sm active:bg-gray-700 focus:outline-none focus:ring-1 focus:ring-white focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                Buy Now
                                </button>
                            </div>
